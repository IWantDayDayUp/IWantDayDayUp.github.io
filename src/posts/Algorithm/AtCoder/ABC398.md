...
So that we only need to move `Two` onjects, and the time complexity is reduced
...
- If $N$ is odd: the first palyer wins if $oo + x$ is odd, and the second does if it is even
- If $N$ is even and $eo = 0$: the first palyer wins if $iso / 2 + x$ is odd, and the second does if it is even
- If $N$ is even and $1 \le eo \le 2$: the first palyer always wins
- If $N$ is even and $eo \ge 3$: the first palyer wins if $oo + x$ is odd, and the second does if it is even
